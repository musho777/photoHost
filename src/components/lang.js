export const t = (lang = 'ru') => {
    ...
    }
    {
        return {
            ...
            Companyname: 'Имя фамилия, название канала или сообщества.',
            search: "Поиск",
            Notfound: "Не найдено",
            ...
            Yourcontent: 'В какую бы рубрику ты не выложил контент, твой контент дойдет точно до адресата и увидят те люди, кто не обязательно подписан на тебя, но выбрали данную рубрику.',
