        ...
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1 }}>
          <ScrollView
            ...
            <Text style={[Styles.balihaiMedium10, { paddingHorizontal: 17, marginTop: 10 }]}>
              Выбери шрифт и цвет для описания о себе.
            </Text>
            ...
            <Text style={[Styles.balihaiMedium10, { paddingHorizontal: 17, marginTop: 5, color: '#FFC24B' }]}>
              Чем больше заполнишь информацию о себе, тем точнее будет предлагаться контент, контент от твоих коллег/конкурентов по сфере/отрасли, а также контент из твоего города.
            </Text>
            <View>
