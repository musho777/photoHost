...
export const Position_professionModal = ({ visible, close, onPress }) => {
  ...
  const constProfesions = [
    ...
    "Когнитивная терапия", "Компьютерная томография", "Косметология", "Космическая отрасль", "Лабораторная диагностика",
    ...
    "Пластическая хирургия", "Полиграфия", "Психиатрия", "Психоанализ", "Психология", "Психотерапия", "Работа с детьми",
    ...
    "Финансы", "Фондовые рынки", "Фотография", "Функциональная диагностика", "Химическая промышленность", "Энергетика",
