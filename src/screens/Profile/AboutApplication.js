    ...
    <ScrollView showsVerticalScrollIndicator={false}>
      ...
      <View style={{ gap: 15, marginBottom: 20 }}>
        <Text style={Styles.balihaiMedium13}>
          ...
          Любите путешествовать? Выбрав эту рубрику, к красочному контенту будут предложены такие рубрики как фрукты, овощи, еда и напитки, города и страны, активный отдых, экстрим, развлечения, природа, времена года, охота и рыбалка, и релакс.
          Интересуетесь недвижимостью? Мы предложим Вам не только крутой контент о новостройках, но и попутно идеи для строительства и даже информацию о строительных инструментах!
        </Text>
        <Text style={Styles.balihaiMedium13}>
          <Text style={[styles.line, { borderBottomWidth: 0 }]}>
